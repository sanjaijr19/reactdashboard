            ...
            <div className="leftside-menu" ref={menuNodeRef}>
                {!hideLogo && (
					...
					<Link to="/" className="logo text-center logo-light">
						  <span className="logo-lg" style={{ color: 'white', marginRight: '18px' }}>
							<img src={isLight ? logoDark : logo} alt="logo" height="24" style={{ marginRight: '6px' }} />
							Stickynote panel 2.5.6
						  </span>

					<span className="logo-sm">
                                <img src={isLight ? logoSm : logo} alt="logo" height="16" />
                            </span>
                        </Link>
